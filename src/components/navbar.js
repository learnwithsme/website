...
export function Footer() {
    ...
    return <footer className="bg-gradient-to-b from-transparent via-slate-700 via-30% to-slate-700 mt-10 pt-[12rem] px-5 md:px-10 pb-10 xl:p-20 text-slate-50 flex flex-wrap flex-row items-center font-['Futura_Std',ui-sans-serif,sans-serif]">
        ...
        <div className="flex flex-wrap flex-row text-md">
            {/* FACEBOOK */}
            <div className="m-2">
                <svg className="inline" fill="#ffffff" width={iconSize} height={iconSize} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.001 2.002c-5.522 0-9.999 4.477-9.999 9.999 0 4.99 3.656 9.126 8.437 9.879v-6.988h-2.54v-2.891h2.54V9.798c0-2.508 1.493-3.891 3.776-3.891 1.094 0 2.24.195 2.24.195v2.459h-1.264c-1.24 0-1.628.772-1.628 1.563v1.875h2.771l-.443 2.891h-2.328v6.988C18.344 21.129 22 16.992 22 12.001c0-5.522-4.477-9.999-9.999-9.999z" /></svg> <a className="align-middle link link-hover" href="https://www.facebook.com/SmeDlsuChapter" target="_blank" rel="noreferrer">Society of Manufacturing Engineers</a>
            </div>
            {/* INSTAGRAM */}
            <div className="m-2">
                <svg className="inline" width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg> <a className="align-middle link link-hover" href="https://www.instagram.com/smedlsu" target="_blank" rel="noreferrer">@smedlsu</a>
            </div>
            {/* LINKEDIN */}
            <div className="m-2">
                <svg className="inline" fill="#ffffff" width={iconSize} height={iconSize} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg> <a className="align-middle link link-hover" href="https://www.linkedin.com/company/sme-dlsu" target="_blank" rel="noreferrer">Society of Manufacturing Engineers - DLSU Student Chapter</a>
            </div>
            {/* EMAIL */}
            <div className="m-2">
                <svg className="inline" fill="#ffffff" width={iconSize} height={iconSize} viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg> <a className="align-middle link link-hover" href="mailto:sme@dlsu.edu.ph" target="_blank" rel="noreferrer">sme@dlsu.edu.ph</a>
            </div>
        </div>
